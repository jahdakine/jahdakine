	...
	<div>
		<article>
			...
			<ul>
				...
				<li>{{ HTML::link("http://validator.w3.org/", "HTML Markup&#8663;", array("title"=>"Open W3C HTML validator in a new window/tab", "target"=>"_blank", "class" => "offsite link-new-win")) }} validation services. </li>
