		...
		<div id="accordion">
			...
			<div class="group">
				...
				<div>
					...
					<p>Maintained all aspects of software licensing, support, and beta testing for commercial traffic engineering/analysis software system. Implemented custom contacts database (MSAccess/VBA) and web front-end (ColdFusion), data entry system interface to traffic records software, and generic "web-SQL" table manipulation tool for online back-end dB administration.</p>
					<h4>Programmer/Analyst II</h4>
					<h5>Access Graphics</h5>
					<h6>July 1998 – April 1999 (10 months) Boulder, Colorado</h6>
					<p>Responsible for maintaining database consistency for mission critical Oracle RDBMS order entry system. Worked with a team of developers to support design, testing, and production environments. Developed import, processing, and test code using common tools on a UNIX platform.</p>
					<h4>Verification/Validation Tester</h4>
					<h5>Colorado MEDtech</h5>
					<h6>October 1997 – June 1998 (9 months) Gunbarrel, Colorado</h6>
					<p>Maintained software functional specification and created test scripts for precision medical product manufacturer using Borland C++, Requisite Pro, and company designed tools. Assisted team with product testing in accordance with ISO and FDA standards.</p>	
				</div>
			</div><!-- group -->
			<div class="group">
			...
			<div class="group">
			    ...
			    <p>John and I worked on ColdFusion Applications at the National Renewable Energy Laboratory where he has been for over 10 years managing dozens of ColdFusion Web Applications. I took over a project where John went far beyond expectations performing the work load of a web team on his own, working a lot of overtime to create a Application form for Renewable Energy grants, a review system and an annual Performance Review System as the sole developer. We now have a larger team on the project which stands on the shoulders of John's initial work. I enjoyed working with John and we had a knack for proposing the same solutions to issues we noticed in the software creating an excellent rapport. John works hard and with focus and enthusiasm taking pride in creating quality web applications. I highly recommend John and hope to work with him again on other projects.</p>
					<p>October 22, 2011, Steven worked directly with John at NREL - National Renewable Energy Laboratory (LinkedIn)</p>
		        ...
		        A company in need of the skills John has would do very well to grab him if he's available.</p>
					<p>October 25, 2011, Pete managed John at Pd' Programming, Inc. (LinkedIn)</p>
				</div>
			</div><!-- group -->
		</div><!-- Accordian -->
	</section>    
