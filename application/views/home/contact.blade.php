...
<section id="communicate">
	<h4>Get in touch</h4>
	<p>To use the mail facilities, please allow popups* from my site <a id="help" href="#" title="Open a section with links to managing popups in major browsers" class="hidden access-link">Help with popups</a>	(this is the only time - I promise).
