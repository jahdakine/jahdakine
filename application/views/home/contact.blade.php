...
<section id="communicate">
	<h4>Get in touch</h4>
	<p>To use the mail facilities, please allow popups from my site <a id="help" href="#" title="Help with popups" class="access-link">Help with popups</a>	(this is the only time - I promise).
	...
	<ul class="nolist">
		...
		<li>
			<a href="callto:jahdakine?call" class="to-top href" id="skype" title="Launch a call to my Skype address" target="_blank">Skype&nbsp;(best&nbsp;to&nbsp;email&nbsp;first&nbsp;-&nbsp;I&nbsp;don't&nbsp;camp&nbsp;out&nbsp;there)</a> 
		</li>
	</ul>
	<p>
